const API_URL = 'https://be-rest-131-1079290367613.us-central1.run.app/api/notes';
...
function handleEditRow(id) {
    ...
    document.querySelector('#update-judul-input').value =
...
function loadHTMLTable(data) {
    ...
    data.forEach(({ id, judul, isi, tanggal_dibuat }) => {
        ...
        <tr>
            ...
            <td>
                <button class="delete-row-btn" data-id="${id}">
                    Delete
                </button>
            </td>
            <td>
                <button class="edit-row-btn" data-id="${id}">
                    Edit
                </button>
            </td>
        </tr>`;
